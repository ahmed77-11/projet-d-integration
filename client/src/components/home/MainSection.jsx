const MainSection = () => {
  return (
    <div className="w-full h-full bg-main z-50 ">
      <div className="w-full h-full flex justify-center items-center bg-search">
      ...
      <div className=" h-full flex flex-col gap-10 items-center justify-center">
        <div className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          ...
          <div className="flex flex-col justify-between p-4 leading-normal">
            ...
            <p className="mb-3 font-normal opacity-50 text-gray-700 dark:text-gray-400">
